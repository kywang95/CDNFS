...
## The predictive performance of real datasets for classification in
...
cases = c("warpAR10P", "ORL", "Isolet1")
cases_scale = c(TRUE, TRUE, TRUE)
for (cases_index in 1:length(cases)){
  for (i_repeat in 1:10){
    iteration = cases[cases_index]
    simulation = "realdata_classification"
